...
<form id="ticketsTypes" action="<?php echo url_for('ticketsTypes/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
...
<script type="text/javascript">
  $(function() {
    new jscolor.color(document.getElementById('tickets_types_background_color'), {adjust:false})
