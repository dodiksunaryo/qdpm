...
<?php 
  ...
  {              
    echo __('Project') . ': ' . select_tag('form_projects_id','',array('choices'  => $choices),array('onChange'=>'load_form_by_projects_id(\'form_container\',\'' . url_for('tasks/newTask') . '\',this.value)','style'=>'width:450px;'));
?>
